...
namespace TE1.Schemas
{
    public class 캘리브자료 : BindingList<캘리브정보>
    {
        ...
        public static 캘리브정보 Calibration(CogToolBlock tool, 카메라구분 카메라, Int32 검사번호)
        {
            ...
            //    Double CalibX = GetOutput<Double>(align, "ResolutionX");
            //    Double CalibY = GetOutput<Double>(align, "ResolutionY");
            //    if (CalibX <= 0 || CalibY <= 0) return null;
            ...
            //    정보.CalibX = Convert.ToDecimal(CalibX);
            //    정보.CalibY = Convert.ToDecimal(CalibY);
