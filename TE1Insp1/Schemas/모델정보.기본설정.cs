...
namespace TE1.Schemas
{
    public enum 모델구분
    {
        [ListBindable(false)]
        None = 0,
        [DXDescription("UPR 3P24S"), Description("UPR 3P24S")]
        UPR3P24S = 1,
        [DXDescription("UPR 2P36S"), Description("UPR 2P36S")]
        UPR2P36S = 2,
    }
    ...
    public class 모델정보
    {
        ...
        public void 수량변경(Int32 양품, Int32 불량)
        {
            this.양품갯수 = 양품;
            this.불량갯수 = 불량;
        }
    ...
    public class 모델자료 : List<모델정보>
    {
        ...
        public void 수량변경(모델구분 모델, Int32 양품, Int32 불량)
        {
            this.GetItem(모델)?.수량변경(양품, 불량);
            this.검사수량변경?.Invoke();
        }
