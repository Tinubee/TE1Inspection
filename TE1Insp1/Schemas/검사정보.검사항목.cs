...
namespace TE1.Schemas
{
    public enum 검사항목 : Int32
    {
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "T020", -1, Hosts.Measure)] T020 = 2020,
        [Result(검사그룹.치수, 장치구분.Cam02, "T021", -1, Hosts.Measure)] T021 = 2021,
        [Result(검사그룹.치수, 장치구분.Cam02, "T022", Hosts.Measure)] T022 = 2022,
        [Result(검사그룹.치수, 장치구분.Cam02, "T023", Hosts.Measure)] T023 = 2023,
        [Result(검사그룹.치수, 장치구분.Cam02, "T024",-1, Hosts.Measure)] T024 = 2024,
        [Result(검사그룹.치수, 장치구분.Cam02, "T025", -1, Hosts.Measure)] T025 = 2025,
        [Result(검사그룹.치수, 장치구분.Cam02, "T026", -1, Hosts.Measure)] T026 = 2026,
        [Result(검사그룹.치수, 장치구분.Cam02, "T027", -1, Hosts.Measure)] T027 = 2027,
        [Result(검사그룹.치수, 장치구분.Cam02, "T028", -1, Hosts.Measure)] T028 = 2028,
        [Result(검사그룹.치수, 장치구분.Cam02, "T029", -1, Hosts.Measure)] T029 = 2029,
        [Result(검사그룹.치수, 장치구분.Cam02, "T030", Hosts.Measure)] T030 = 2030,
        [Result(검사그룹.치수, 장치구분.Cam02, "T031", -1, Hosts.Measure)] T031 = 2031,
        [Result(검사그룹.치수, 장치구분.Cam02, "T032", Hosts.Measure)] T032 = 2032,
        [Result(검사그룹.치수, 장치구분.Cam02, "T033", -1,Hosts.Measure)] T033 = 2033,
        [Result(검사그룹.치수, 장치구분.Cam02, "T034", -1, Hosts.Measure)] T034 = 2034,
        [Result(검사그룹.치수, 장치구분.Cam02, "T035", Hosts.Measure)] T035 = 2035,
        [Result(검사그룹.치수, 장치구분.Cam02, "T036", -1, Hosts.Measure)] T036 = 2036,
        [Result(검사그룹.치수, 장치구분.Cam02, "T037", -1, Hosts.Measure)] T037 = 2037,
        [Result(검사그룹.치수, 장치구분.Cam02, "T038", -1, Hosts.Measure)] T038 = 2038,
        [Result(검사그룹.치수, 장치구분.Cam03, "T039", -1,Hosts.Measure)] T039 = 2039,
        [Result(검사그룹.치수, 장치구분.Cam02, "T040", -1,Hosts.Measure)] T040 = 2040,
        [Result(검사그룹.치수, 장치구분.Cam02, "T041", -1, Hosts.Measure)] T041 = 2041,
        [Result(검사그룹.치수, 장치구분.Cam02, "T042", -1, Hosts.Measure)] T042 = 2042,
        [Result(검사그룹.치수, 장치구분.Cam02, "T043", -1,Hosts.Measure)] T043 = 2043,
        [Result(검사그룹.치수, 장치구분.Cam02, "T044", Hosts.Measure)] T044 = 2044,
        [Result(검사그룹.치수, 장치구분.Cam02, "T045", Hosts.Measure)] T045 = 2045,
        [Result(검사그룹.치수, 장치구분.Cam02, "T046", -1,Hosts.Measure)] T046 = 2046,
        [Result(검사그룹.치수, 장치구분.Cam02, "T047", -1,Hosts.Measure)] T047 = 2047,
        ...
        [Result(검사그룹.치수, 장치구분.Cam03, "ImSheetM1TR", Hosts.Measure)] ImSheetM1TR = 7008,
        [Result(검사그룹.치수, 장치구분.Cam03, "ImSheetM1BR", Hosts.Measure)] ImSheetM1BR = 7009,
        [Result(검사그룹.치수, 장치구분.Cam03, "ImSheetM1TL", Hosts.Measure)] ImSheetM1TL = 7010,
        [Result(검사그룹.치수, 장치구분.Cam03, "ImSheetM1BL", Hosts.Measure)] ImSheetM1BL = 7011,
        [Result(검사그룹.치수, 장치구분.Cam03, "ImSheetM2TR", Hosts.Measure)] ImSheetM2TR = 7012,
        [Result(검사그룹.치수, 장치구분.Cam03, "ImSheetM2BR", Hosts.Measure)] ImSheetM2BR = 7013,
        [Result(검사그룹.치수, 장치구분.Cam03, "ImSheetM2TL", Hosts.Measure)] ImSheetM2TL = 7014,
        [Result(검사그룹.치수, 장치구분.Cam03, "ImSheetM2BL", Hosts.Measure)] ImSheetM2BL = 7015,
        // 8. Surface
