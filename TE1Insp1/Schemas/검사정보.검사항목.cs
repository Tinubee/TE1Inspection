...
namespace TE1.Schemas
{
    public enum 검사항목 : Int32
    {
        ...
        [Result(검사그룹.치수, 장치구분.Cam03, "T015", Hosts.Measure)] T015 = 2015,
        ...
        [Result(검사그룹.치수, 장치구분.Cam03, "T020", Hosts.Measure)] T020 = 2020,
        [Result(검사그룹.치수, 장치구분.Cam02, "T021", -1, Hosts.Measure)] T021 = 2021,
        [Result(검사그룹.치수, 장치구분.Cam02, "T022", -1, Hosts.Measure)] T022 = 2022,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "T032", -1, Hosts.Measure)] T032 = 2032,
        [Result(검사그룹.치수, 장치구분.Cam02, "T033", Hosts.Measure)] T033 = 2033,
        [Result(검사그룹.치수, 장치구분.Cam02, "T034", -1, Hosts.Measure)] T034 = 2034,
        [Result(검사그룹.치수, 장치구분.Cam02, "T035", -1, Hosts.Measure)] T035 = 2035,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "T044", -1, Hosts.Measure)] T044 = 2044,
        ...
        [Result(검사그룹.치수, 장치구분.Cam03, "T048", -1, Hosts.Measure)] T048 = 2048,
