...
namespace TE1.Schemas
{
    public enum 검사항목 : Int32
    {
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "T201")] T201 = 2201,
        [Result(검사그룹.치수, 장치구분.Cam02, "T203")] T203 = 2203,
        [Result(검사그룹.치수, 장치구분.Cam02, "T205")] T205 = 2205,
        [Result(검사그룹.치수, 장치구분.Cam02, "T207")] T207 = 2207,
        [Result(검사그룹.치수, 장치구분.Cam02, "T209")] T209 = 2209,
        [Result(검사그룹.치수, 장치구분.Cam02, "T210")] T210 = 2210,
        [Result(검사그룹.치수, 장치구분.Cam02, "T211")] T211 = 2211,
        [Result(검사그룹.치수, 장치구분.Cam02, "T212")] T212 = 2212,
        [Result(검사그룹.치수, 장치구분.Cam02, "T213")] T213 = 2213,
        [Result(검사그룹.치수, 장치구분.Cam02, "T214")] T214 = 2214,
        [Result(검사그룹.치수, 장치구분.Cam02, "T216")] T216 = 2216,
        [Result(검사그룹.치수, 장치구분.Cam02, "T218")] T218 = 2218,
        [Result(검사그룹.치수, 장치구분.Cam02, "T220")] T220 = 2220,
        [Result(검사그룹.치수, 장치구분.Cam02, "T222")] T222 = 2222,

        [Result(검사그룹.치수, 장치구분.Cam03, "T301")] T301 = 2301,
        [Result(검사그룹.치수, 장치구분.Cam02, "T302")] T302 = 2302,
        [Result(검사그룹.치수, 장치구분.Cam02, "T303")] T303 = 2303,
        [Result(검사그룹.치수, 장치구분.Cam02, "T304")] T304 = 2304,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "T504")] T504 = 2504,
        [Result(검사그룹.치수, 장치구분.Cam02, "T505")] T505 = 2505,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "T706")] T706 = 2706,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "T808")] T808 = 2808,
