...
namespace TE1.Schemas
{
    public enum 검사항목 : Int32
    {
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H01L", Hosts.Measure)] H01L = 1014,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H02L", Hosts.Measure)] H02L = 1024,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H03L", Hosts.Measure)] H03L = 1034,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H04L", Hosts.Measure)] H04L = 1044,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H05L", Hosts.Measure)] H05L = 1054,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H06L", Hosts.Measure)] H06L = 1064,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H07L", Hosts.Measure)] H07L = 1074,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H08L", Hosts.Measure)] H08L = 1084,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H09L", Hosts.Measure)] H09L = 1094,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H10L", Hosts.Measure)] H10L = 1104,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H11L", Hosts.Measure)] H11L = 1114,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H12L", Hosts.Measure)] H12L = 1124,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H13L", Hosts.Measure)] H13L = 1134,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H14L", Hosts.Measure)] H14L = 1144,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H15L", Hosts.Measure)] H15L = 1154,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H16L", Hosts.Measure)] H16L = 1164,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H17L", Hosts.Measure)] H17L = 1174,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H18L", Hosts.Measure)] H18L = 1184,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H19L", Hosts.Measure)] H19L = 1194,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H20L", Hosts.Measure)] H20L = 1204,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H21L", Hosts.Measure)] H21L = 1214,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H22L", Hosts.Measure)] H22L = 1224,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H23L", Hosts.Measure)] H23L = 1234,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H24L", Hosts.Measure)] H24L = 1244,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H25L", Hosts.Measure)] H25L = 1254,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H26L", Hosts.Measure)] H26L = 1264,
        ...
        [Result(검사그룹.치수, 장치구분.Cam02, "H27L", Hosts.Measure)] H27L = 1274,
        ...
        //[Result(검사그룹.치수, 장치구분.Cam02, "H38L", Hosts.Measure)] H38L = 1384,
        ...
        // 2. Trim
        [Result(검사그룹.치수, 장치구분.Cam02, "T101", Hosts.Measure)] T101 = 2101,
        [Result(검사그룹.치수, 장치구분.Cam02, "T103", Hosts.Measure)] T103 = 2103,
        [Result(검사그룹.치수, 장치구분.Cam02, "T105", Hosts.Measure)] T105 = 2105,
        [Result(검사그룹.치수, 장치구분.Cam02, "T107", Hosts.Measure)] T107 = 2107,
        [Result(검사그룹.치수, 장치구분.Cam02, "T109", Hosts.Measure)] T109 = 2109,
        [Result(검사그룹.치수, 장치구분.Cam02, "T111", Hosts.Measure)] T111 = 2111,
        [Result(검사그룹.치수, 장치구분.Cam02, "T113", Hosts.Measure)] T113 = 2113,
        [Result(검사그룹.치수, 장치구분.Cam02, "T115", Hosts.Measure)] T115 = 2115,
        [Result(검사그룹.치수, 장치구분.Cam02, "T117", Hosts.Measure)] T117 = 2117,
        [Result(검사그룹.치수, 장치구분.Cam02, "T119", Hosts.Measure)] T119 = 2119,

        [Result(검사그룹.치수, 장치구분.Cam02, "T201", -1, Hosts.Measure)] T201 = 2201,
        [Result(검사그룹.치수, 장치구분.Cam02, "T203", -1, Hosts.Measure)] T203 = 2203,
        [Result(검사그룹.치수, 장치구분.Cam02, "T205", -1, Hosts.Measure)] T205 = 2205,
        [Result(검사그룹.치수, 장치구분.Cam02, "T207", -1, Hosts.Measure)] T207 = 2207,
        [Result(검사그룹.치수, 장치구분.Cam02, "T209", -1, Hosts.Measure)] T209 = 2209,
        [Result(검사그룹.치수, 장치구분.Cam02, "T210", Hosts.Measure)] T210 = 2210,
        [Result(검사그룹.치수, 장치구분.Cam02, "T211", -1, Hosts.Measure)] T211 = 2211,
        [Result(검사그룹.치수, 장치구분.Cam02, "T212", -1, Hosts.Measure)] T212 = 2212,
        [Result(검사그룹.치수, 장치구분.Cam02, "T213", Hosts.Measure)] T213 = 2213,
        [Result(검사그룹.치수, 장치구분.Cam02, "T214", -1, Hosts.Measure)] T214 = 2214,
        [Result(검사그룹.치수, 장치구분.Cam02, "T216", -1, Hosts.Measure)] T216 = 2216,
        [Result(검사그룹.치수, 장치구분.Cam02, "T218", -1, Hosts.Measure)] T218 = 2218,
        [Result(검사그룹.치수, 장치구분.Cam02, "T220", -1, Hosts.Measure)] T220 = 2220,
        [Result(검사그룹.치수, 장치구분.Cam02, "T222", -1, Hosts.Measure)] T222 = 2222,

        [Result(검사그룹.치수, 장치구분.Cam03, "T301", Hosts.Measure)] T301 = 2301,
        [Result(검사그룹.치수, 장치구분.Cam02, "T302", Hosts.Measure)] T302 = 2302,
        [Result(검사그룹.치수, 장치구분.Cam02, "T303", -1, Hosts.Measure)] T303 = 2303,
        [Result(검사그룹.치수, 장치구분.Cam02, "T304", -1, Hosts.Measure)] T304 = 2304,

        [Result(검사그룹.치수, 장치구분.Cam02, "T401", Hosts.Measure)] T401 = 2401,
        [Result(검사그룹.치수, 장치구분.Cam02, "T402", Hosts.Measure)] T402 = 2402,
        [Result(검사그룹.치수, 장치구분.Cam02, "T403", Hosts.Measure)] T403 = 2403,
        [Result(검사그룹.치수, 장치구분.Cam02, "T404", Hosts.Measure)] T404 = 2404,

        [Result(검사그룹.치수, 장치구분.Cam02, "T501", Hosts.Measure)] T501 = 2501,
        [Result(검사그룹.치수, 장치구분.Cam02, "T503", Hosts.Measure)] T503 = 2503,
        [Result(검사그룹.치수, 장치구분.Cam02, "T504", -1, Hosts.Measure)] T504 = 2504,
        [Result(검사그룹.치수, 장치구분.Cam02, "T505", -1, Hosts.Measure)] T505 = 2505,

        [Result(검사그룹.치수, 장치구분.Cam02, "T601", Hosts.Measure)] T601 = 2601,
        [Result(검사그룹.치수, 장치구분.Cam02, "T602", Hosts.Measure)] T602 = 2602,
        [Result(검사그룹.치수, 장치구분.Cam02, "T603", Hosts.Measure)] T603 = 2603,
        [Result(검사그룹.치수, 장치구분.Cam02, "T604", Hosts.Measure)] T604 = 2604,

        [Result(검사그룹.치수, 장치구분.Cam03, "T701", -1, Hosts.Measure)] T701 = 2701,
        [Result(검사그룹.치수, 장치구분.Cam02, "T702", -1, Hosts.Measure)] T702 = 2702,
        [Result(검사그룹.치수, 장치구분.Cam02, "T703", Hosts.Measure)] T703 = 2703,
        [Result(검사그룹.치수, 장치구분.Cam02, "T705", Hosts.Measure)] T705 = 2705,
        [Result(검사그룹.치수, 장치구분.Cam02, "T706", -1, Hosts.Measure)] T706 = 2706,
        [Result(검사그룹.치수, 장치구분.Cam02, "T707", Hosts.Measure)] T707 = 2707,

        [Result(검사그룹.치수, 장치구분.Cam03, "T801", Hosts.Measure)] T801 = 2801,
        [Result(검사그룹.치수, 장치구분.Cam02, "T803", Hosts.Measure)] T803 = 2803,
        [Result(검사그룹.치수, 장치구분.Cam02, "T804", Hosts.Measure)] T804 = 2804,
        [Result(검사그룹.치수, 장치구분.Cam02, "T806", Hosts.Measure)] T806 = 2806,
        [Result(검사그룹.치수, 장치구분.Cam02, "T807", Hosts.Measure)] T807 = 2807,
        [Result(검사그룹.치수, 장치구분.Cam03, "T808", Hosts.Measure)] T808 = 2808,
        ...
        [Result(검사그룹.치수, 장치구분.Cam03, "M01Y4", -1, Hosts.Measure)] M01Y4 = 4014,

        [Result(검사그룹.치수, 장치구분.Cam03, "M02X1", -1, Hosts.Measure)] M02X1 = 4021,
        [Result(검사그룹.치수, 장치구분.Cam03, "M02Y2", Hosts.Measure)] M02Y2 = 4022,
        [Result(검사그룹.치수, 장치구분.Cam03, "M02X3", Hosts.Measure)] M02X3 = 4023,
        [Result(검사그룹.치수, 장치구분.Cam03, "M02Y4", -1, Hosts.Measure)] M02Y4 = 4024,

        [Result(검사그룹.치수, 장치구분.Cam03, "M03X1", -1, Hosts.Measure)] M03X1 = 4031,
        [Result(검사그룹.치수, 장치구분.Cam03, "M03Y2", Hosts.Measure)] M03Y2 = 4032,
        [Result(검사그룹.치수, 장치구분.Cam03, "M03X3", Hosts.Measure)] M03X3 = 4033,
        [Result(검사그룹.치수, 장치구분.Cam03, "M03Y4", -1, Hosts.Measure)] M03Y4 = 4034,

        [Result(검사그룹.치수, 장치구분.Cam03, "M04X1", -1, Hosts.Measure)] M04X1 = 4041,
        [Result(검사그룹.치수, 장치구분.Cam03, "M04Y2", Hosts.Measure)] M04Y2 = 4042,
        [Result(검사그룹.치수, 장치구분.Cam03, "M04X3", Hosts.Measure)] M04X3 = 4043,
        [Result(검사그룹.치수, 장치구분.Cam03, "M04Y4", -1, Hosts.Measure)] M04Y4 = 4044,

        [Result(검사그룹.치수, 장치구분.Cam03, "M05X1", -1, Hosts.Measure)] M05X1 = 4051,
        [Result(검사그룹.치수, 장치구분.Cam03, "M05Y2", Hosts.Measure)] M05Y2 = 4052,
        [Result(검사그룹.치수, 장치구분.Cam03, "M05X3", Hosts.Measure)] M05X3 = 4053,
        [Result(검사그룹.치수, 장치구분.Cam03, "M05Y4", -1, Hosts.Measure)] M05Y4 = 4054,

        [Result(검사그룹.치수, 장치구분.Cam03, "M06X1", -1, Hosts.Measure)] M06X1 = 4061,
        [Result(검사그룹.치수, 장치구분.Cam03, "M06Y2", Hosts.Measure)] M06Y2 = 4062,
        [Result(검사그룹.치수, 장치구분.Cam03, "M06X3", Hosts.Measure)] M06X3 = 4063,
        [Result(검사그룹.치수, 장치구분.Cam03, "M06Y4", -1, Hosts.Measure)] M06Y4 = 4064,

        [Result(검사그룹.치수, 장치구분.Cam03, "M07X1", -1, Hosts.Measure)] M07X1 = 4071,
        [Result(검사그룹.치수, 장치구분.Cam03, "M07Y2", Hosts.Measure)] M07Y2 = 4072,
        [Result(검사그룹.치수, 장치구분.Cam03, "M07X3", Hosts.Measure)] M07X3 = 4073,
        [Result(검사그룹.치수, 장치구분.Cam03, "M07Y4", -1, Hosts.Measure)] M07Y4 = 4074,

        [Result(검사그룹.치수, 장치구분.Cam03, "M08X1", -1, Hosts.Measure)] M08X1 = 4081,
        [Result(검사그룹.치수, 장치구분.Cam03, "M08Y2", Hosts.Measure)] M08Y2 = 4082,
        [Result(검사그룹.치수, 장치구분.Cam03, "M08X3", Hosts.Measure)] M08X3 = 4083,
        [Result(검사그룹.치수, 장치구분.Cam03, "M08Y4", -1, Hosts.Measure)] M08Y4 = 4084,

        [Result(검사그룹.치수, 장치구분.Cam03, "M09X1", -1, Hosts.Measure)] M09X1 = 4091,
        [Result(검사그룹.치수, 장치구분.Cam03, "M09Y2", Hosts.Measure)] M09Y2 = 4092,
        [Result(검사그룹.치수, 장치구분.Cam03, "M09X3", Hosts.Measure)] M09X3 = 4093,
        [Result(검사그룹.치수, 장치구분.Cam03, "M09Y4", -1, Hosts.Measure)] M09Y4 = 4094,

        [Result(검사그룹.치수, 장치구분.Cam03, "M10X1", -1, Hosts.Measure)] M10X1 = 4101,
        [Result(검사그룹.치수, 장치구분.Cam03, "M10Y2", Hosts.Measure)] M10Y2 = 4102,
        [Result(검사그룹.치수, 장치구분.Cam03, "M10X3", Hosts.Measure)] M10X3 = 4103,
        [Result(검사그룹.치수, 장치구분.Cam03, "M10Y4", -1, Hosts.Measure)] M10Y4 = 4104,

        [Result(검사그룹.치수, 장치구분.Cam03, "M11X1", -1, Hosts.Measure)] M11X1 = 4111,
        [Result(검사그룹.치수, 장치구분.Cam03, "M11Y2", Hosts.Measure)] M11Y2 = 4112,
        [Result(검사그룹.치수, 장치구분.Cam03, "M11X3", Hosts.Measure)] M11X3 = 4113,
        [Result(검사그룹.치수, 장치구분.Cam03, "M11Y4", -1, Hosts.Measure)] M11Y4 = 4114,

        [Result(검사그룹.치수, 장치구분.Cam03, "M12X1", -1, Hosts.Measure)] M12X1 = 4121,
        [Result(검사그룹.치수, 장치구분.Cam03, "M12Y2", Hosts.Measure)] M12Y2 = 4122,
        [Result(검사그룹.치수, 장치구분.Cam03, "M12X3", Hosts.Measure)] M12X3 = 4123,
        [Result(검사그룹.치수, 장치구분.Cam03, "M12Y4", -1, Hosts.Measure)] M12Y4 = 4124,

        [Result(검사그룹.치수, 장치구분.Cam03, "M13X1", -1, Hosts.Measure)] M13X1 = 4131,
        [Result(검사그룹.치수, 장치구분.Cam03, "M13Y2", Hosts.Measure)] M13Y2 = 4132,
        [Result(검사그룹.치수, 장치구분.Cam03, "M13X3", Hosts.Measure)] M13X3 = 4133,
        [Result(검사그룹.치수, 장치구분.Cam03, "M13Y4", -1, Hosts.Measure)] M13Y4 = 4134,

        [Result(검사그룹.치수, 장치구분.Cam03, "M14X1", -1, Hosts.Measure)] M14X1 = 4141,
        [Result(검사그룹.치수, 장치구분.Cam03, "M14Y2", Hosts.Measure)] M14Y2 = 4142,
        [Result(검사그룹.치수, 장치구분.Cam03, "M14X3", Hosts.Measure)] M14X3 = 4143,
        [Result(검사그룹.치수, 장치구분.Cam03, "M14Y4", -1, Hosts.Measure)] M14Y4 = 4144,

        [Result(검사그룹.치수, 장치구분.Cam03, "M15X1", -1, Hosts.Measure)] M15X1 = 4151,
        [Result(검사그룹.치수, 장치구분.Cam03, "M15Y2", Hosts.Measure)] M15Y2 = 4152,
        [Result(검사그룹.치수, 장치구분.Cam03, "M15X3", Hosts.Measure)] M15X3 = 4153,
        [Result(검사그룹.치수, 장치구분.Cam03, "M15Y4", -1, Hosts.Measure)] M15Y4 = 4154,

        [Result(검사그룹.치수, 장치구분.Cam03, "M16X1", -1, Hosts.Measure)] M16X1 = 4161,
        [Result(검사그룹.치수, 장치구분.Cam03, "M16Y2", -1, Hosts.Measure)] M16Y2 = 4162,
        [Result(검사그룹.치수, 장치구분.Cam03, "M16X3", Hosts.Measure)] M16X3 = 4163,
        [Result(검사그룹.치수, 장치구분.Cam03, "M16Y4", Hosts.Measure)] M16Y4 = 4164,

        [Result(검사그룹.치수, 장치구분.Cam03, "M17X1", -1, Hosts.Measure)] M17X1 = 4171,
        [Result(검사그룹.치수, 장치구분.Cam03, "M17Y2", -1, Hosts.Measure)] M17Y2 = 4172,
        [Result(검사그룹.치수, 장치구분.Cam03, "M17X3", Hosts.Measure)] M17X3 = 4173,
        [Result(검사그룹.치수, 장치구분.Cam03, "M17Y4", Hosts.Measure)] M17Y4 = 4174,

        [Result(검사그룹.치수, 장치구분.Cam03, "M18X1", -1, Hosts.Measure)] M18X1 = 4181,
        [Result(검사그룹.치수, 장치구분.Cam03, "M18Y2", -1, Hosts.Measure)] M18Y2 = 4182,
        [Result(검사그룹.치수, 장치구분.Cam03, "M18X3", Hosts.Measure)] M18X3 = 4183,
        [Result(검사그룹.치수, 장치구분.Cam03, "M18Y4", Hosts.Measure)] M18Y4 = 4184,

        [Result(검사그룹.치수, 장치구분.Cam03, "M19X1", -1, Hosts.Measure)] M19X1 = 4191,
        [Result(검사그룹.치수, 장치구분.Cam03, "M19Y2", -1, Hosts.Measure)] M19Y2 = 4192,
        [Result(검사그룹.치수, 장치구분.Cam03, "M19X3", Hosts.Measure)] M19X3 = 4193,
        [Result(검사그룹.치수, 장치구분.Cam03, "M19Y4", Hosts.Measure)] M19Y4 = 4194,

        [Result(검사그룹.치수, 장치구분.Cam03, "M20X1", -1, Hosts.Measure)] M20X1 = 4201,
        [Result(검사그룹.치수, 장치구분.Cam03, "M20Y2", -1, Hosts.Measure)] M20Y2 = 4202,
        [Result(검사그룹.치수, 장치구분.Cam03, "M20X3", Hosts.Measure)] M20X3 = 4203,
        [Result(검사그룹.치수, 장치구분.Cam03, "M20Y4", Hosts.Measure)] M20Y4 = 4204,

        [Result(검사그룹.치수, 장치구분.Cam03, "M21X1", -1, Hosts.Measure)] M21X1 = 4211,
        [Result(검사그룹.치수, 장치구분.Cam03, "M21Y2", -1, Hosts.Measure)] M21Y2 = 4212,
        [Result(검사그룹.치수, 장치구분.Cam03, "M21X3", Hosts.Measure)] M21X3 = 4213,
        [Result(검사그룹.치수, 장치구분.Cam03, "M21Y4", Hosts.Measure)] M21Y4 = 4214,

        [Result(검사그룹.치수, 장치구분.Cam03, "M22X1", -1, Hosts.Measure)] M22X1 = 4221,
        [Result(검사그룹.치수, 장치구분.Cam03, "M22Y2", -1, Hosts.Measure)] M22Y2 = 4222,
        [Result(검사그룹.치수, 장치구분.Cam03, "M22X3", Hosts.Measure)] M22X3 = 4223,
        [Result(검사그룹.치수, 장치구분.Cam03, "M22Y4", Hosts.Measure)] M22Y4 = 4224,

        [Result(검사그룹.치수, 장치구분.Cam03, "M23X1", -1, Hosts.Measure)] M23X1 = 4231,
        [Result(검사그룹.치수, 장치구분.Cam03, "M23Y2", -1, Hosts.Measure)] M23Y2 = 4232,
        [Result(검사그룹.치수, 장치구분.Cam03, "M23X3", Hosts.Measure)] M23X3 = 4233,
        [Result(검사그룹.치수, 장치구분.Cam03, "M23Y4", Hosts.Measure)] M23Y4 = 4234,

        [Result(검사그룹.치수, 장치구분.Cam03, "M24X1", -1, Hosts.Measure)] M24X1 = 4241,
        [Result(검사그룹.치수, 장치구분.Cam03, "M24Y2", -1, Hosts.Measure)] M24Y2 = 4242,
        [Result(검사그룹.치수, 장치구분.Cam03, "M24X3", Hosts.Measure)] M24X3 = 4243,
        [Result(검사그룹.치수, 장치구분.Cam03, "M24Y4", Hosts.Measure)] M24Y4 = 4244,

        [Result(검사그룹.치수, 장치구분.Cam03, "M25X1", -1, Hosts.Measure)] M25X1 = 4251,
        [Result(검사그룹.치수, 장치구분.Cam03, "M25Y2", -1, Hosts.Measure)] M25Y2 = 4252,
        [Result(검사그룹.치수, 장치구분.Cam03, "M25X3", Hosts.Measure)] M25X3 = 4253,
        [Result(검사그룹.치수, 장치구분.Cam03, "M25Y4", Hosts.Measure)] M25Y4 = 4254,

        [Result(검사그룹.치수, 장치구분.Cam03, "M26X1", -1, Hosts.Measure)] M26X1 = 4261,
        [Result(검사그룹.치수, 장치구분.Cam03, "M26Y2", -1, Hosts.Measure)] M26Y2 = 4262,
        [Result(검사그룹.치수, 장치구분.Cam03, "M26X3", Hosts.Measure)] M26X3 = 4263,
        [Result(검사그룹.치수, 장치구분.Cam03, "M26Y4", Hosts.Measure)] M26Y4 = 4264,

        [Result(검사그룹.치수, 장치구분.Cam03, "M27X1", -1, Hosts.Measure)] M27X1 = 4271,
        [Result(검사그룹.치수, 장치구분.Cam03, "M27Y2", -1, Hosts.Measure)] M27Y2 = 4272,
        [Result(검사그룹.치수, 장치구분.Cam03, "M27X3", Hosts.Measure)] M27X3 = 4273,
        [Result(검사그룹.치수, 장치구분.Cam03, "M27Y4", Hosts.Measure)] M27Y4 = 4274,

        [Result(검사그룹.치수, 장치구분.Cam03, "M28X1", -1, Hosts.Measure)] M28X1 = 4281,
        [Result(검사그룹.치수, 장치구분.Cam03, "M28Y2", -1, Hosts.Measure)] M28Y2 = 4282,
        ...
        [Result(검사그룹.치수, 장치구분.Cam03, "M30X1", -1, Hosts.Measure)] M30X1 = 4301,
        [Result(검사그룹.치수, 장치구분.Cam03, "M30Y2", -1, Hosts.Measure)] M30Y2 = 4302,
        [Result(검사그룹.치수, 장치구분.Cam03, "M30X3", Hosts.Measure)] M30X3 = 4303,
        [Result(검사그룹.치수, 장치구분.Cam03, "M30Y4", Hosts.Measure)] M30Y4 = 4304,

        [Result(검사그룹.치수, 장치구분.Cam03, "M31X1", -1, Hosts.Measure)] M31X1 = 4311,
        [Result(검사그룹.치수, 장치구분.Cam03, "M31Y2", Hosts.Measure)] M31Y2 = 4312,
        [Result(검사그룹.치수, 장치구분.Cam03, "M31X3", Hosts.Measure)] M31X3 = 4313,
        [Result(검사그룹.치수, 장치구분.Cam03, "M31Y4", -1, Hosts.Measure)] M31Y4 = 4314,

        [Result(검사그룹.치수, 장치구분.Cam03, "M32X1", -1, Hosts.Measure)] M32X1 = 4321,
        [Result(검사그룹.치수, 장치구분.Cam03, "M32Y2", Hosts.Measure)] M32Y2 = 4322,
        [Result(검사그룹.치수, 장치구분.Cam03, "M32X3", Hosts.Measure)] M32X3 = 4323,
        [Result(검사그룹.치수, 장치구분.Cam03, "M32Y4", -1, Hosts.Measure)] M32Y4 = 4324,

        [Result(검사그룹.치수, 장치구분.Cam03, "M33X1", -1, Hosts.Measure)] M33X1 = 4331,
        [Result(검사그룹.치수, 장치구분.Cam03, "M33Y2", Hosts.Measure)] M33Y2 = 4332,
        [Result(검사그룹.치수, 장치구분.Cam03, "M33X3", Hosts.Measure)] M33X3 = 4333,
        [Result(검사그룹.치수, 장치구분.Cam03, "M33Y4", -1, Hosts.Measure)] M33Y4 = 4334,

        [Result(검사그룹.치수, 장치구분.Cam03, "M34X1", -1, Hosts.Measure)] M34X1 = 4341,
        [Result(검사그룹.치수, 장치구분.Cam03, "M34Y2", Hosts.Measure)] M34Y2 = 4342,
        [Result(검사그룹.치수, 장치구분.Cam03, "M34X3", Hosts.Measure)] M34X3 = 4343,
        [Result(검사그룹.치수, 장치구분.Cam03, "M34Y4", -1, Hosts.Measure)] M34Y4 = 4344,

        [Result(검사그룹.치수, 장치구분.Cam03, "M35X1", -1, Hosts.Measure)] M35X1 = 4351,
        [Result(검사그룹.치수, 장치구분.Cam03, "M35Y2", Hosts.Measure)] M35Y2 = 4352,
        [Result(검사그룹.치수, 장치구분.Cam03, "M35X3", Hosts.Measure)] M35X3 = 4353,
        [Result(검사그룹.치수, 장치구분.Cam03, "M35Y4", -1, Hosts.Measure)] M35Y4 = 4354,

        [Result(검사그룹.치수, 장치구분.Cam03, "M36X1", -1, Hosts.Measure)] M36X1 = 4361,
        [Result(검사그룹.치수, 장치구분.Cam03, "M36Y2", Hosts.Measure)] M36Y2 = 4362,
        [Result(검사그룹.치수, 장치구분.Cam03, "M36X3", Hosts.Measure)] M36X3 = 4363,
        [Result(검사그룹.치수, 장치구분.Cam03, "M36Y4", -1, Hosts.Measure)] M36Y4 = 4364,

        [Result(검사그룹.치수, 장치구분.Cam03, "M37X1", -1, Hosts.Measure)] M37X1 = 4371,
        [Result(검사그룹.치수, 장치구분.Cam03, "M37Y2", Hosts.Measure)] M37Y2 = 4372,
        [Result(검사그룹.치수, 장치구분.Cam03, "M37X3", Hosts.Measure)] M37X3 = 4373,
        [Result(검사그룹.치수, 장치구분.Cam03, "M37Y4", -1, Hosts.Measure)] M37Y4 = 4374,

        [Result(검사그룹.치수, 장치구분.Cam03, "M38X1", -1, Hosts.Measure)] M38X1 = 4381,
        [Result(검사그룹.치수, 장치구분.Cam03, "M38Y2", Hosts.Measure)] M38Y2 = 4382,
        [Result(검사그룹.치수, 장치구분.Cam03, "M38X3", Hosts.Measure)] M38X3 = 4383,
        [Result(검사그룹.치수, 장치구분.Cam03, "M38Y4", -1, Hosts.Measure)] M38Y4 = 4384,

        [Result(검사그룹.치수, 장치구분.Cam03, "M39X1", -1, Hosts.Measure)] M39X1 = 4391,
        [Result(검사그룹.치수, 장치구분.Cam03, "M39Y2", Hosts.Measure)] M39Y2 = 4392,
        [Result(검사그룹.치수, 장치구분.Cam03, "M39X3", Hosts.Measure)] M39X3 = 4393,
        [Result(검사그룹.치수, 장치구분.Cam03, "M39Y4", -1, Hosts.Measure)] M39Y4 = 4394,

        [Result(검사그룹.치수, 장치구분.Cam03, "M40X1", -1, Hosts.Measure)] M40X1 = 4401,
        [Result(검사그룹.치수, 장치구분.Cam03, "M40Y2", Hosts.Measure)] M40Y2 = 4402,
        [Result(검사그룹.치수, 장치구분.Cam03, "M40X3", Hosts.Measure)] M40X3 = 4403,
        [Result(검사그룹.치수, 장치구분.Cam03, "M40Y4", -1, Hosts.Measure)] M40Y4 = 4404,

        [Result(검사그룹.치수, 장치구분.Cam03, "M41X1", -1, Hosts.Measure)] M41X1 = 4411,
        [Result(검사그룹.치수, 장치구분.Cam03, "M41Y2", Hosts.Measure)] M41Y2 = 4412,
        [Result(검사그룹.치수, 장치구분.Cam03, "M41X3", Hosts.Measure)] M41X3 = 4413,
        [Result(검사그룹.치수, 장치구분.Cam03, "M41Y4", -1, Hosts.Measure)] M41Y4 = 4414,

        [Result(검사그룹.치수, 장치구분.Cam03, "M42X1", -1, Hosts.Measure)] M42X1 = 4421,
        [Result(검사그룹.치수, 장치구분.Cam03, "M42Y2", Hosts.Measure)] M42Y2 = 4422,
        [Result(검사그룹.치수, 장치구분.Cam03, "M42X3", Hosts.Measure)] M42X3 = 4423,
        [Result(검사그룹.치수, 장치구분.Cam03, "M42Y4", -1, Hosts.Measure)] M42Y4 = 4424,

        [Result(검사그룹.치수, 장치구분.Cam03, "M43X1", -1, Hosts.Measure)] M43X1 = 4431,
        [Result(검사그룹.치수, 장치구분.Cam03, "M43Y2", Hosts.Measure)] M43Y2 = 4432,
        [Result(검사그룹.치수, 장치구분.Cam03, "M43X3", Hosts.Measure)] M43X3 = 4433,
        [Result(검사그룹.치수, 장치구분.Cam03, "M43Y4", -1, Hosts.Measure)] M43Y4 = 4434,

        [Result(검사그룹.치수, 장치구분.Cam03, "M44X1", -1, Hosts.Measure)] M44X1 = 4441,
        [Result(검사그룹.치수, 장치구분.Cam03, "M44Y2", Hosts.Measure)] M44Y2 = 4442,
        [Result(검사그룹.치수, 장치구분.Cam03, "M44X3", Hosts.Measure)] M44X3 = 4443,
        [Result(검사그룹.치수, 장치구분.Cam03, "M44Y4", -1, Hosts.Measure)] M44Y4 = 4444,

        [Result(검사그룹.치수, 장치구분.Cam03, "M45X1", -1, Hosts.Measure)] M45X1 = 4451,
        [Result(검사그룹.치수, 장치구분.Cam03, "M45Y2", Hosts.Measure)] M45Y2 = 4452,
        [Result(검사그룹.치수, 장치구분.Cam03, "M45X3", Hosts.Measure)] M45X3 = 4453,
        [Result(검사그룹.치수, 장치구분.Cam03, "M45Y4", -1, Hosts.Measure)] M45Y4 = 4454,

        [Result(검사그룹.치수, 장치구분.Cam03, "M46X1", -1, Hosts.Measure)] M46X1 = 4461,
        [Result(검사그룹.치수, 장치구분.Cam03, "M46Y2", -1, Hosts.Measure)] M46Y2 = 4462,
        [Result(검사그룹.치수, 장치구분.Cam03, "M46X3", Hosts.Measure)] M46X3 = 4463,
        [Result(검사그룹.치수, 장치구분.Cam03, "M46Y4", Hosts.Measure)] M46Y4 = 4464,

        [Result(검사그룹.치수, 장치구분.Cam03, "M47X1", -1, Hosts.Measure)] M47X1 = 4471,
        [Result(검사그룹.치수, 장치구분.Cam03, "M47Y2", -1, Hosts.Measure)] M47Y2 = 4472,
        [Result(검사그룹.치수, 장치구분.Cam03, "M47X3", Hosts.Measure)] M47X3 = 4473,
        [Result(검사그룹.치수, 장치구분.Cam03, "M47Y4", Hosts.Measure)] M47Y4 = 4474,

        [Result(검사그룹.치수, 장치구분.Cam03, "M48X1", -1, Hosts.Measure)] M48X1 = 4481,
        [Result(검사그룹.치수, 장치구분.Cam03, "M48Y2", -1, Hosts.Measure)] M48Y2 = 4482,
        [Result(검사그룹.치수, 장치구분.Cam03, "M48X3", Hosts.Measure)] M48X3 = 4483,
        [Result(검사그룹.치수, 장치구분.Cam03, "M48Y4", Hosts.Measure)] M48Y4 = 4484,

        [Result(검사그룹.치수, 장치구분.Cam03, "M49X1", -1, Hosts.Measure)] M49X1 = 4491,
        [Result(검사그룹.치수, 장치구분.Cam03, "M49Y2", -1, Hosts.Measure)] M49Y2 = 4492,
        [Result(검사그룹.치수, 장치구분.Cam03, "M49X3", Hosts.Measure)] M49X3 = 4493,
        [Result(검사그룹.치수, 장치구분.Cam03, "M49Y4", Hosts.Measure)] M49Y4 = 4494,

        [Result(검사그룹.치수, 장치구분.Cam03, "M50X1", -1, Hosts.Measure)] M50X1 = 4501,
        [Result(검사그룹.치수, 장치구분.Cam03, "M50Y2", -1, Hosts.Measure)] M50Y2 = 4502,
        [Result(검사그룹.치수, 장치구분.Cam03, "M50X3", Hosts.Measure)] M50X3 = 4503,
        [Result(검사그룹.치수, 장치구분.Cam03, "M50Y4", Hosts.Measure)] M50Y4 = 4504,

        [Result(검사그룹.치수, 장치구분.Cam03, "M51X1", -1, Hosts.Measure)] M51X1 = 4511,
        [Result(검사그룹.치수, 장치구분.Cam03, "M51Y2", -1, Hosts.Measure)] M51Y2 = 4512,
        [Result(검사그룹.치수, 장치구분.Cam03, "M51X3", Hosts.Measure)] M51X3 = 4513,
        [Result(검사그룹.치수, 장치구분.Cam03, "M51Y4", Hosts.Measure)] M51Y4 = 4514,

        [Result(검사그룹.치수, 장치구분.Cam03, "M52X1", -1, Hosts.Measure)] M52X1 = 4521,
        [Result(검사그룹.치수, 장치구분.Cam03, "M52Y2", -1, Hosts.Measure)] M52Y2 = 4522,
        [Result(검사그룹.치수, 장치구분.Cam03, "M52X3", Hosts.Measure)] M52X3 = 4523,
        [Result(검사그룹.치수, 장치구분.Cam03, "M52Y4", Hosts.Measure)] M52Y4 = 4524,

        [Result(검사그룹.치수, 장치구분.Cam03, "M53X1", -1, Hosts.Measure)] M53X1 = 4531,
        [Result(검사그룹.치수, 장치구분.Cam03, "M53Y2", -1, Hosts.Measure)] M53Y2 = 4532,
        [Result(검사그룹.치수, 장치구분.Cam03, "M53X3", Hosts.Measure)] M53X3 = 4533,
        [Result(검사그룹.치수, 장치구분.Cam03, "M53Y4", Hosts.Measure)] M53Y4 = 4534,

        [Result(검사그룹.치수, 장치구분.Cam03, "M54X1", -1, Hosts.Measure)] M54X1 = 4541,
        [Result(검사그룹.치수, 장치구분.Cam03, "M54Y2", -1, Hosts.Measure)] M54Y2 = 4542,
        [Result(검사그룹.치수, 장치구분.Cam03, "M54X3", Hosts.Measure)] M54X3 = 4543,
        [Result(검사그룹.치수, 장치구분.Cam03, "M54Y4", Hosts.Measure)] M54Y4 = 4544,

        [Result(검사그룹.치수, 장치구분.Cam03, "M55X1", -1, Hosts.Measure)] M55X1 = 4551,
        [Result(검사그룹.치수, 장치구분.Cam03, "M55Y2", -1, Hosts.Measure)] M55Y2 = 4552,
        [Result(검사그룹.치수, 장치구분.Cam03, "M55X3", Hosts.Measure)] M55X3 = 4553,
        [Result(검사그룹.치수, 장치구분.Cam03, "M55Y4", Hosts.Measure)] M55Y4 = 4554,

        [Result(검사그룹.치수, 장치구분.Cam03, "M56X1", -1, Hosts.Measure)] M56X1 = 4561,
        [Result(검사그룹.치수, 장치구분.Cam03, "M56Y2", -1, Hosts.Measure)] M56Y2 = 4562,
        [Result(검사그룹.치수, 장치구분.Cam03, "M56X3", Hosts.Measure)] M56X3 = 4563,
        [Result(검사그룹.치수, 장치구분.Cam03, "M56Y4", Hosts.Measure)] M56Y4 = 4564,

        [Result(검사그룹.치수, 장치구분.Cam03, "M57X1", -1, Hosts.Measure)] M57X1 = 4571,
        [Result(검사그룹.치수, 장치구분.Cam03, "M57Y2", -1, Hosts.Measure)] M57Y2 = 4572,
        [Result(검사그룹.치수, 장치구분.Cam03, "M57X3", Hosts.Measure)] M57X3 = 4573,
        [Result(검사그룹.치수, 장치구분.Cam03, "M57Y4", Hosts.Measure)] M57Y4 = 4574,

        [Result(검사그룹.치수, 장치구분.Cam03, "M58X1", -1, Hosts.Measure)] M58X1 = 4581,
        [Result(검사그룹.치수, 장치구분.Cam03, "M58Y2", -1, Hosts.Measure)] M58Y2 = 4582,
        [Result(검사그룹.치수, 장치구분.Cam03, "M58X3", Hosts.Measure)] M58X3 = 4583,
        [Result(검사그룹.치수, 장치구분.Cam03, "M58Y4", Hosts.Measure)] M58Y4 = 4584,

        [Result(검사그룹.치수, 장치구분.Cam03, "M59X1", -1, Hosts.Measure)] M59X1 = 4591,
        [Result(검사그룹.치수, 장치구분.Cam03, "M59Y2", -1, Hosts.Measure)] M59Y2 = 4592,
        [Result(검사그룹.치수, 장치구분.Cam03, "M59X3", Hosts.Measure)] M59X3 = 4593,
        [Result(검사그룹.치수, 장치구분.Cam03, "M59Y4", Hosts.Measure)] M59Y4 = 4594,

        [Result(검사그룹.치수, 장치구분.Cam03, "M60X1", -1, Hosts.Measure)] M60X1 = 4601,
        [Result(검사그룹.치수, 장치구분.Cam03, "M60Y2", -1, Hosts.Measure)] M60Y2 = 4602,
