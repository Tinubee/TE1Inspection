...
namespace TE1.Schemas
{
    ...
    public class 로그테이블 : Data.BaseTable
    {
        ...
        public async Task<List<로그정보>> Select() => await this.Select(DateTime.Today);
        ...
        public int 자료정리(int 일수)
        {
            ...
            String Sql = $@"DELETE FROM {환경설정.LogTableName} WHERE ltime < DATE('{Utils.FormatDate(일자, "{0:yyyy-MM-dd}")}')";
            try
            {
                int AffectedRows = 0;
