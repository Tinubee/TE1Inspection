...
namespace TE1.UI.Forms
{
    public partial class StateForm : XtraForm
    {
        ...
        private void 검사결과(검사결과 결과)
        {
            ...
            this.e치수.Appearance.ForeColor = 환경설정.ResultColor(결과.치수결과);
            this.e외관.Appearance.ForeColor = 환경설정.ResultColor(결과.외관결과);
            this.e큐알.Text = 결과.큐알내용;
            this.e순번.Text = 결과.검사번호.ToString("d4");
