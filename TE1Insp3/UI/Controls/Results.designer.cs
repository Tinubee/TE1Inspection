...
namespace TE1.UI.Controls
{
    partial class Results
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.GridView2.AllowSettingsMenu = true;
            ...
            gridLevelNode2.RelationName = "표면불량";
            ...
            this.GridView3.ViewCaption = "Surface defects";
            // 
            // col장치구분
            // 
            this.col장치구분.AppearanceCell.Options.UseTextOptions = true;
            this.col장치구분.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
            ...
            // col불량유형
            // 
            this.col불량유형.AppearanceCell.Options.UseTextOptions = true;
            this.col불량유형.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
            ...
            this.col신뢰점수.DisplayFormat.FormatString = "{0:#,0.00}";
            this.col신뢰점수.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
            this.col신뢰점수.FieldName = "신뢰점수";
            this.col신뢰점수.Name = "col신뢰점수";
            this.col신뢰점수.Visible = true;
            this.col신뢰점수.VisibleIndex = 2;
            // 
            // col검출크기
            // 
            ...
            this.col검출크기.DisplayFormat.FormatString = "{0:#,0}";
            this.col검출크기.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
            this.col검출크기.FieldName = "검출크기";
            this.col검출크기.Name = "col검출크기";
            this.col검출크기.Visible = true;
            this.col검출크기.VisibleIndex = 3;
            // 
            // GridView1
            // 
            ...
            this.col큐알등급.VisibleIndex = 7;
            this.col큐알등급.Width = 100;
            // 
            // col큐알내용
            // 
