...
namespace TE1
{
    public static class InsItems
    {
        ...
        public static InsItem T201 = new InsItem(1, InsType.Y, -57.71, +230.58);
        public static InsItem T203 = new InsItem(1, InsType.Y, -114.09, +230.58);
        public static InsItem T205 = new InsItem(1, InsType.Y, -224.35, +230.58);
        public static InsItem T207 = new InsItem(1, InsType.Y, -343.50, +230.58);
        public static InsItem T209 = new InsItem(1, InsType.Y, -430.06, +230.58);
        public static InsItem T210 = new InsItem(1, InsType.X, -446.50, +219.54);
        public static InsItem T211 = new InsItem(1, InsType.Y, -466.38, +205.58);
        public static InsItem T212 = new InsItem(1, InsType.Y, -533.90, +205.58);
        public static InsItem T213 = new InsItem(1, InsType.X, -553.50, +218.26);
        public static InsItem T214 = new InsItem(1, InsType.Y, -560.18, +230.58);
        public static InsItem T216 = new InsItem(1, InsType.Y, -625.03, +230.58);
        public static InsItem T218 = new InsItem(1, InsType.Y, -736.17, +230.58);
        public static InsItem T220 = new InsItem(1, InsType.Y, -838.91, +230.58);
        public static InsItem T222 = new InsItem(1, InsType.Y, -929.97, +230.58);

        public static InsItem T301 = new InsItem(3, InsType.X, -47.90, +193.32);
        public static InsItem T302 = new InsItem(1, InsType.X, -47.90, +151.44);
        public static InsItem T303 = new InsItem(1, InsType.Y, -34.00, +130.18);
        public static InsItem T304 = new InsItem(1, InsType.Y, -10.74, +130.18);
        ...
        public static InsItem T501 = new InsItem(1, InsType.X, -942.10, +221.95);
        public static InsItem T503 = new InsItem(1, InsType.X, -942.10, +144.86);
        public static InsItem T504 = new InsItem(1, InsType.Y, -952.99, +130.18);
        public static InsItem T505 = new InsItem(1, InsType.Y, -978.25, +130.18);
        ...
        public static InsItem T705 = new InsItem(1, InsType.X, -2.50, +19.08);
        public static InsItem T706 = new InsItem(1, InsType.X, 0.00, +66.39);
        public static InsItem T707 = new InsItem(1, InsType.X, 0.00, +113.02);
        ...
        public static InsItem T806 = new InsItem(1, InsType.X, -987.50, +18.03);
        public static InsItem T807 = new InsItem(1, InsType.X, -990.00, +82.86);
        public static InsItem T808 = new InsItem(1, InsType.X, -990.00, +121.40);
