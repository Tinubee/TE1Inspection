...
namespace TE1
{
    ...
    public static class InsItems
    {
        ...
        public static InsItem T016 = new InsItem(2, InsType.X, -987.50, -18.13);
        public static InsItem T017 = new InsItem(2, InsType.X, -987.50, +18.03);
        public static InsItem T018 = new InsItem(2, InsType.X, -990.00, +82.86);
        public static InsItem T019 = new InsItem(2, InsType.X, -990.00, +121.40);
        public static InsItem T020 = new InsItem(2, InsType.Y, -978.25, +130.18);
        public static InsItem T021 = new InsItem(2, InsType.Y, -952.99, +130.18);
        public static InsItem T022 = new InsItem(2, InsType.X, -942.10, +144.86);
        public static InsItem T023 = new InsItem(2, InsType.X, -942.10, +221.95);
        public static InsItem T024 = new InsItem(2, InsType.Y, -929.97, +230.58);
        public static InsItem T025 = new InsItem(2, InsType.Y, -874.45, 206.85);
        public static InsItem T026 = new InsItem(2, InsType.Y, -838.91, +230.58);
        public static InsItem T027 = new InsItem(2, InsType.Y, -810.52, 206.85);
        ...
        public static InsItem T035 = new InsItem(2, InsType.X, -446.50, +219.54);
        public static InsItem T036 = new InsItem(2, InsType.Y, -430.06, +230.58);
        public static InsItem T037 = new InsItem(2, InsType.Y, -406.39, 215.56);
        public static InsItem T038 = new InsItem(2, InsType.Y, -343.50, +230.58);
        public static InsItem T039 = new InsItem(2, InsType.Y, -224.35, +230.58);
        public static InsItem T040 = new InsItem(2, InsType.Y, -199.56, 206.85);
        ...
        public static InsItem T048 = new InsItem(2, InsType.X, 0.00, +113.02);
        public static InsItem T049 = new InsItem(2, InsType.X, 0.00, +66.39);
        public static InsItem T050 = new InsItem(2, InsType.X, -2.50, +19.08);
        public static InsItem T051 = new InsItem(2, InsType.X, 0.00, -82.07);
        public static InsItem T052 = new InsItem(2, InsType.X, 0.00, -120.84);
        public static InsItem T053 = new InsItem(2, InsType.Y, -10.36, -130.18);
        public static InsItem T054 = new InsItem(2, InsType.Y, -36.28, -130.18);
        public static InsItem T055 = new InsItem(2, InsType.X, -47.90, -143.79);
        public static InsItem T056 = new InsItem(2, InsType.X, -47.90, -189.84);
