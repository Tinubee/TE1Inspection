...
namespace TE1.UI.Controls
{
    public partial class CamViewers : XtraUserControl
    {
        ...
        public void Init(ViewType type = ViewType.Inspect)
        {
            ...
            뷰어.Add(카메라구분.Cam05, this.e좌측캠);
            뷰어.Add(카메라구분.Cam06, this.e우측캠);
            뷰어.ForEach(v => {
                v.Value.Init(false);
            ...
            d좌측캠.Text = MvUtils.Utils.GetDescription(카메라구분.Cam05);
            d우측캠.Text = MvUtils.Utils.GetDescription(카메라구분.Cam06);
        }
        public void Close() { }
    }
}
